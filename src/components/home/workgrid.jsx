    ...
    <section className="py-24  border-t border-black/5 dark:border-white/5 w-full">
      <div className="max-w-screen-2xl mx-auto">
       <div className="w-full p-1 flex sm:flex-row border-b border-neutral-700 flex-col sm:justify-between items-center">
         <h2 className="font-display text-4xl min-[264px]:text-6xl md:text-8xl uppercase text-center pb-4">
          CURATED <br />
          (WORK)
        </h2>
        <span className="font-display text-4xl  min-[264px]:text-6xl  md:text-8xl ">12-25</span>
       </div>
